  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#0a0a1a] to-[#111] p-4 md:p-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 md:gap-0 position-sticky top-0 bg-[#0a0a1a] z-10 p-4 md:p-6 rounded-2xl border border-yellow-500/30">

...
export default function Footer() {
    return (
        <footer className="bg-gray-950 text-gray-300 py-16 px-6 sm:px-20 z-0">
                ...
                <div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-2 mb-4 w-full">
                        <input
                            ...
                            className="flex-1 min-w-0 px-4 py-3 rounded-full bg-gray-800 text-white placeholder-gray-400 focus:outline-none border border-gray-700 focus:border-yellow-500 transition-all"
                        />
                        <Button className="w-full sm:w-auto bg-yellow-500 hover:bg-yellow-600 rounded-full px-6 py-3 text-white font-semibold transition-all">
                            Subscribe
                        </Button>
                    </div>
